      ...
      <div className="max-w-2xl mx-auto">
        <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-lg shadow-md`}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="word" className={`block text-sm font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                Word (in Khmer)
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="pronunciation" className={`block text-sm font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                Pronunciation
              </label>
              <input
                type="text"
                ...
                onChange={(e) => setWordData({ ...wordData, pronunciation: e.target.value })}
              />
            </div>

            <div>
              <label htmlFor="englishMeaning" className={`block text-sm font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                English Meaning
              </label>
              <input
                type="text"
                ...
                onChange={(e) => setWordData({ ...wordData, englishMeaning: e.target.value })}
              />
            </div>
